...
const services = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'New! Zen Head Spa 30 mins no blow dry', time: '35 mins', description: ['Waterfall Head Spa'], price: '$75' },
      { name: 'New! Zen Head Spa 30 mins with blow dry', time: '1 hr', description: ['Waterfall Head Spa'], price: '$125' },
      { name: 'New! Zen Head Spa 50 mins no blow dry', time: '1 hr', description: ['Waterfall Head Spa'], price: '$120' },
      { name: 'New! Zen Head Spa 50 mins with blow dry', time: '1 hr and 20 mins', description: ['Waterfall Head Spa'], price: '$170' },
      {
