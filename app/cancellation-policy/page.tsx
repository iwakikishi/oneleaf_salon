...
export const metadata: Metadata = {
  title: 'Cancellation Policy | OneLeaf Salon',
  description: 'Read OneLeaf Salon\'s cancellation policy, including punctuality expectations, no-show fees, and rescheduling guidelines.',
};
